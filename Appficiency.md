0. Greetings Hi, Noha, how are you doing today? 


1. Why Appficiency?
   - the unique **position** the company has as a top NetSuite partner. You don’t just build software, but solve real business problems in industries like construction and manufacturing. I really like that combination of technology and business impact.
   - **project scale**， contribute to meaningful solutions that could potentially impact thousands of people
   - Another big reason is your **international and diverse environment**. I know Appficiency works with global clients and teams, and values collaboration across cultures. For me, that’s a great opportunity to broaden my international perspective and learn from people with very different backgrounds.
   - I’m very interested in **technology consulting**. I understand it can sometimes be high-pressure, but I believe that is what makes the growth so fast.

2. Why this position?
   - On the technical side, I’ll be working with a broad set of web development tools like JavaScript, TypeScript, React, .NET, and NetSuite SuiteScript, which will deepen my understanding of full-stack development.
   - What excites me even more is that this role emphasizes understanding the business logic before coding. I think that’s an essential skill for a developer, and it’s something I want to strengthen — being able to bridge technology with real business problems.

3. Why you?
   - Tech stacks
   - Ability to adapt: 在不同框架间转换过
   - Collaboration + Passion

4. Tell me about yourself. [Equivalent] Walk me through your resume.
   - Background: Of course! Just to give you a quick overview, I actually have a blended background in both business and computer science. I started my studies in Rotman Commerce, and gained a strong foundation in business. I also polished my people skills at Rotman. Later I transitioned into Computer Science because I wanted to focus more on the technology side. I see the growing potentials of GenAI and how it can change people's lives. Along the way, I've done well academically, (I think you can see that from my transcript). But more importantly, I really enjoy applying my knowledge to real-world projects and building meaningful softwares.
   - Project/Internship: For example, I recently worked as an AI intern at BSH, where I helped develop a food freshness detection system on Raspberry Pi devices. I helped deploy the Python model. I also built a prototype. It was an intelligent refrigerator testing data monitor system, which saved test engineers one hour a day. Re:Pair Genomics: the internal Human Resources Management. I proposed a serverless architecture for the system. This solution made the system scalable, and also cut the infrastructure costs by over $100 per employee per month. I was also working part-time at the Rotman School of Management and helped them maintain their trading apps. That's an evidence of combining tech and business.

5. Experience with NetSuite / Web Development
   Web Development: BSH Smart Monitor / HRM - similar to ERP
